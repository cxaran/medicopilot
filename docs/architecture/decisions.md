...
Decision: MedicoPilot opera como single installation / single organization.
...
- `compose.e2e.yml` usa el proyecto Docker `medicopilot-e2e`;
- Postgres usa la base `medicopilot_e2e_test` sobre almacenamiento temporal;
