...
/**
 * Mapeo del error de un turno fallido a un mensaje para el médico (en español). Por defecto
 ...
 * sólo expone ``providerStatus``; la decisión de UX (clínica) vive aquí, en el frontend.
 */
