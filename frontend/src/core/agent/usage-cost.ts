...
/**
 * Contabilidad de USO y COSTO por médico (P7, paridad OpenClaw, provider-neutral). Igual que el
 * resto de la inteligencia del copiloto, vive en el NAVEGADOR del médico autenticado: la sesión
 * del panel ES la del médico, así que el acumulado por sesión es intrínsecamente por-médico (no
 * hay libro mayor en servidor en P7; el gateway ya reporta el uso por turno sin secretos ni PHI).
 *
 ...
 *
 * Sin secretos ni PHI: este módulo solo maneja CONTEOS e identificadores de modelo.
 */
