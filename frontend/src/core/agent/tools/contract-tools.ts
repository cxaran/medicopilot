...
// `clinical.*` por cada endpoint, este módulo SINTETIZA ToolDefinitions genéricas (crear/editar/
...
//    guía rica y flujos especiales (dedup, SOAP, escalas…)— la derivada se OMITE.
//  - Las escrituras llevan metadata de aprobación (P1): nada se guarda sin el médico.
...
/** Cola de resumen (P1): primer par etiqueta:valor presente, para el plan que aprueba el médico. */
