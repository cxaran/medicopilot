 ...
 * marca centrada (orbe animado + "MediCopilot"), título/descripción de la página y una tarjeta
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-[var(--bg)] px-4 py-10 text-[var(--tx)]">
      ...
      <div className="relative z-[1] m-auto flex w-full max-w-[392px] flex-col items-center">
        ...
        <p className="text-blur-intro-delay mt-2 text-center text-[14.5px] text-[var(--tx2)]">
          {title}
        </p>
        {description ? (
