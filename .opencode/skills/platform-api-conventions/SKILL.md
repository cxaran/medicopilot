...
description: Use when editing FastAPI routes, Pydantic schemas, REST endpoints, pagination, filters, OpenAPI, RBAC permissions, database-facing API contracts, or API error behavior in medicopilot.
---

# Platform API Conventions

Use this skill for backend API work in `medicopilot`.
