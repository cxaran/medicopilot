...
description: Use when adding or editing list/filter endpoints, building ResourceQuery, QueryOptions, QueryPolicy, FieldSpec, OffsetPage pagination, or Pydantic HTTP contracts (ApiReadSchema/ApiWriteSchema/ApiPatchSchema, XCreate/XRead/XUpdate) in medicopilot.
---
