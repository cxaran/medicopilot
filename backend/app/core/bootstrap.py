...
def bootstrap_initial_data() -> None:
    ...
    with Session(engine) as session:
        ...
        # El rol admin del SISTEMA puede ser el que creó el wizard de setup (no el del seed);
        # los permisos declarados después de ese setup no le llegan solos. Reconciliación
        # aditiva: repone los faltantes sin retirar ni reactivar nada.
