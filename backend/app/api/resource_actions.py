...
def get_active_or_404(
    ...
    *,
    ...
    p. ej. exigir un paciente ``ACTIVE`` o una consulta ``DRAFT``."""
...
def soft_delete_entity(
    ...
    *,
    ...
    es la convención de borrado del dominio clínico. Es idempotente-seguro: si el
    registro ya está eliminado responde el conflicto estándar."""
