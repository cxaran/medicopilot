...
class AuditEvent(Base):
    """Evento de auditoría append-only del expediente y la operación del sistema."""
    ...
    action: Mapped[str] = mapped_column(
        String(120),
        nullable=False,
        comment="Acción realizada, por ejemplo consultation_finalized o prescription_approved.",
    )
