...
(app → backup_token → ai_credential). El re-cifrado es PEREZOSO: como toda
escritura usa la primaria, el material viejo migra de clave la próxima vez que su
registro se reescribe — sin migración masiva ni ventana de indisponibilidad.
