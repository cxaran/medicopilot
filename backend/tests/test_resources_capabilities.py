...
class PermissionsCatalogTest(unittest.TestCase):
    ...
    def test_grouped_catalog_exposes_labels(self) -> None:
        ...
        self.assertEqual(names, ["users", "roles", "doctors", "medication_templates", "patients", "patient_clinical_items", "medical_history_versions", "consultations", "consultation_diagnoses", "vital_signs", "lab_results", "clinical_events", "study_orders", "clinical_tasks", "prescriptions", "appointments", "clinical_documents", "population", "reports", "institutional_settings", "clinical_codes", "clinical_scales", "permissions"])
        for group in groups:
