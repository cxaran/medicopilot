...
class BootstrapRoutesTest(unittest.TestCase):
    ...
    def test_catalog_only_before_setup(self) -> None:
        ...
        self.assertEqual([group["name"] for group in body["permission_groups"]], ["users", "roles", "doctors", "medication_templates", "patients", "patient_clinical_items", "patient_history_items", "patient_immunizations", "medical_history_versions", "consultations", "consultation_diagnoses", "vital_signs", "lab_results", "clinical_events", "study_orders", "clinical_tasks", "prescriptions", "appointments", "clinical_documents", "population", "reports", "institutional_settings", "clinical_codes", "clinical_scales", "scale_results", "clinical_notes", "quality_checks", "medication_reconciliation", "follow_ups", "audit_events", "permissions"])
