...
/**
 * Adaptador de runtime de inferencia LOCAL / on-prem (Ollama / vLLM). Importa clínicamente:
 * inferencia dentro del consultorio donde NINGÚN proveedor en la nube ve datos del paciente
 * (la PHI nunca sale de la clínica). Tanto Ollama como vLLM exponen endpoints chat
