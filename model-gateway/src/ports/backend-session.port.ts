...
//
// El gateway NO es la autoridad de la sesión clínica: no tiene el secreto de firma de los
// JWT del backend (por eso existe el connection-ticket con su propio secreto). Para saber si
// la sesión del médico SIGUE VIVA en el momento de correr un turno, el gateway reenvía la
